    ...
    <div className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
          ...
          <Link to="/membership" className="bg-white rounded-lg shadow-md overflow-hidden min-h-full flex flex-col">
            ...
            <div className="px-6 py-4">
              <button className="w-full py-3 px-6 bg-indigo-600 text-white font-bold rounded-md hover:bg-indigo-700 transition duration-300">Sign Up</button>
            </div>
          </Link>
